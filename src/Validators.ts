...
export class Validators {
    ...
    private validateNumbers (_doc: any, numberFields: { propertyKey: string, min?: number, max?: number }[]): void {
    ...
    private validateStrings (_doc: any, stringFields: { propertyKey: string, match?: RegExp }[]): void {
    ...
    private validateDates (_doc: any, dateFields: { propertyKey: string, min?: Date, max?: Date }[]): void {
